...
public final class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String jsonResponce) {
        ...
        try {
            ...
            JSONObject responce = baseJsonResponse.getJSONObject("response");
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                News newsObject = new News(title, article, url, date, author);
